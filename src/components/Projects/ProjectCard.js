...
export const ProjectCard = ({ project }) => {
  ...
  return (
    // Project section
    <>{isAboveMediumScreens ? <motion.section
    ...
    >
      <div className="relative overflow-hidden">
        ...
        <motion.div
          className={`flex gap-2 justify-center items-center absolute top-0 left-0 bottom-0 right-0 rounded-lg ${isAboveMediumScreens ? `opacity-0 hover:bg-black hover:bg-opacity-40` : `opacity-70 bg-black/40`}`}
        >
          {url && (
            <a href={url} target="_blank" rel="noreferrer">
              <motion.div
